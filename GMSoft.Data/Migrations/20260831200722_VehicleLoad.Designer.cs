...
namespace GMSoft.Data.Migrations
{
    ...
    [Migration("20260831200722_VehicleLoad")]
    partial class VehicleLoad
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GMSoft.Domain.Entities.VehicleLoad", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("VehicleId", "ConsumedBySessionId");
            ...
            modelBuilder.Entity("GMSoft.Domain.Entities.VehicleLoad", b =>
                {
                    b.HasOne("GMSoft.Domain.Entities.DeliverySession", "ConsumedBySession")
                        .WithMany()
